...
const RUSHING: StatDefinition[] = [
  ...
  d({ canonicalKey: "broken_tackles", label: "Broken Tackles", shortLabel: "BT", scope: "player", side: "offense", category: "rushing", aggregate: "sum",
    aliases: ["rushBrokenTackles", "brokenTackles"], usedFor: ["eos_payout", "leaderboard"] }),
  d({ canonicalKey: "rush_yards_after_contact", label: "Rush Yards After Contact", shortLabel: "YAC", scope: "player", side: "offense", category: "rushing", aggregate: "sum",
    valueType: "yards", unit: "yards", aliases: ["rushYdsAfterContact", "rushYAC", "rush_yac"], usedFor: ["eos_payout", "leaderboard"] }),
  d({ canonicalKey: "rush_20_plus", label: "20+ Yard Rushes", shortLabel: "20+", scope: "player", side: "offense", category: "rushing", aggregate: "sum",
    aliases: ["rush20PlusYds", "rush20Plus"] }),
  // derived
...
const RECEIVING: StatDefinition[] = [
  ...
  d({ canonicalKey: "rec_yards_after_catch", label: "Yards After Catch", shortLabel: "YAC", scope: "player", side: "offense", category: "receiving", aggregate: "sum",
    valueType: "yards", unit: "yards", aliases: ["recYdsAfterCatch", "yardsAfterCatch", "yac"] }),
  // derived
...
const KICKING: StatDefinition[] = [
  ...
  d({ canonicalKey: "fg_50_attempts", label: "50+ Field Goal Attempts", shortLabel: "50+ Att", scope: "player", side: "special_teams", category: "kicking", aggregate: "sum",
    aliases: ["fG50PlusAtt", "fg50PlusAtt", "fg_50_plus_attempts"], usedFor: ["eos_payout"] }),
  d({ canonicalKey: "fg_50_made", label: "50+ Field Goals Made", shortLabel: "50+ M", scope: "player", side: "special_teams", category: "kicking", aggregate: "sum",
    aliases: ["fG50PlusMade", "fg50PlusMade", "fg_50_plus_made"], usedFor: ["eos_payout"] }),
  d({ canonicalKey: "kickoff_attempts", label: "Kickoff Attempts", shortLabel: "KO", scope: "player", side: "special_teams", category: "kicking", aggregate: "sum",
    aliases: ["kickoffAtt", "kickoffs"] }),
  d({ canonicalKey: "kickoff_touchbacks", label: "Kickoff Touchbacks", shortLabel: "KO TB", scope: "player", side: "special_teams", category: "kicking", aggregate: "sum",
    aliases: ["kickoffTBs", "kickoffTouchbacks"] }),
  // derived
...
const PUNTING: StatDefinition[] = [
  d({ canonicalKey: "punts", label: "Punts", shortLabel: "Pnt", scope: "player", side: "special_teams", category: "punting", aggregate: "sum",
    aliases: ["puntNum", "puntAttempts", "punt_att", "puntAtt"] }),
  ...
  d({ canonicalKey: "punt_long", label: "Longest Punt", shortLabel: "Lng", scope: "player", side: "special_teams", category: "punting", aggregate: "max",
    valueType: "yards", unit: "yards", aliases: ["puntLong", "longestPunt", "puntLongest"] }),
  ...
  d({ canonicalKey: "touchbacks", label: "Touchbacks", shortLabel: "TB", scope: "player", side: "special_teams", category: "punting", aggregate: "sum",
    aliases: ["puntTouchbacks", "puntTBs"] }),
  // derived
...
const TEAM_OFFENSE: StatDefinition[] = [
  ...
  d({ canonicalKey: "total_offense_yards", label: "Total Offensive Yards", shortLabel: "Tot Yds", scope: "team", side: "offense", category: "team_offense", aggregate: "sum",
    valueType: "yards", unit: "yards", aliases: ["totalYards", "offenseYards", "totalOffense", "total_offensive_yards", "offTotalYds"], usedFor: ["challenge", "eos_payout", "leaderboard"] }),
  d({ canonicalKey: "team_pass_yards", label: "Team Passing Yards", shortLabel: "Pass Yds", scope: "team", side: "offense", category: "team_offense", aggregate: "sum",
    valueType: "yards", unit: "yards", aliases: ["teamPassYards", "offPassYds"], usedFor: ["challenge", "eos_payout"] }),
  d({ canonicalKey: "team_rush_yards", label: "Team Rushing Yards", shortLabel: "Rush Yds", scope: "team", side: "offense", category: "team_offense", aggregate: "sum",
    valueType: "yards", unit: "yards", aliases: ["teamRushYards", "offRushYds"], usedFor: ["challenge", "eos_payout"] }),
  d({ canonicalKey: "first_downs", label: "First Downs", shortLabel: "1st Dn", scope: "team", side: "offense", category: "team_offense", aggregate: "sum",
    aliases: ["firstDowns", "off1stDowns"], usedFor: ["challenge"] }),
  ...
  d({ canonicalKey: "red_zone_td_rate", label: "Red Zone TD Rate", shortLabel: "RZ TD%", scope: "team", side: "offense", category: "team_offense", aggregate: "latest",
    valueType: "percentage", precision: 1, aliases: ["redZoneTdRate", "redZoneTDRate", "red_zone_td_pct", "redZoneTDPct", "offRedZonePct"], usedFor: ["eos_payout", "leaderboard"] }),
  d({ canonicalKey: "turnovers", label: "Giveaways", shortLabel: "GA", scope: "team", side: "offense", category: "team_offense", aggregate: "sum",
    higherIsBetter: false, aliases: ["giveaways", "teamTurnovers", "tOGiveaways"], usedFor: ["challenge", "eos_payout"] }),
...
const TEAM_DEFENSE: StatDefinition[] = [
  ...
  d({ canonicalKey: "total_yards_allowed", label: "Total Yards Allowed", shortLabel: "Yds All", scope: "team", side: "defense", category: "team_defense", aggregate: "sum",
    valueType: "yards", unit: "yards", higherIsBetter: false, aliases: ["yardsAllowed", "totalYardsAllowed", "opponentTotalYards", "defTotalYds"], usedFor: ["eos_payout", "leaderboard"] }),
  d({ canonicalKey: "pass_yards_allowed", label: "Passing Yards Allowed", shortLabel: "Pass All", scope: "team", side: "defense", category: "team_defense", aggregate: "sum",
    valueType: "yards", unit: "yards", higherIsBetter: false, aliases: ["passYardsAllowed", "passingYardsAllowed", "opponentPassYards", "defPassYds"], usedFor: ["challenge", "eos_payout"] }),
  d({ canonicalKey: "rush_yards_allowed", label: "Rushing Yards Allowed", shortLabel: "Rush All", scope: "team", side: "defense", category: "team_defense", aggregate: "sum",
    valueType: "yards", unit: "yards", higherIsBetter: false, aliases: ["rushYardsAllowed", "rushingYardsAllowed", "opponentRushYards", "defRushYds"], usedFor: ["challenge", "eos_payout"] }),
  d({ canonicalKey: "takeaways", label: "Takeaways", shortLabel: "TA", scope: "team", side: "defense", category: "team_defense", aggregate: "sum",
    aliases: ["defensiveTurnovers", "turnoversForced", "tOTakeaways"], usedFor: ["challenge", "eos_payout", "leaderboard"] }),
  ...
  d({ canonicalKey: "team_interceptions", label: "Team Interceptions", shortLabel: "INT", scope: "team", side: "defense", category: "team_defense", aggregate: "sum",
    aliases: ["teamInterceptions", "defensiveInterceptions", "defIntsRec"], usedFor: ["eos_payout", "challenge", "leaderboard"] }),
  ...
  d({ canonicalKey: "red_zone_td_rate_allowed", label: "Red Zone TD Rate Allowed", shortLabel: "RZ TD% Alw", scope: "team", side: "defense", category: "team_defense", aggregate: "latest",
    valueType: "percentage", precision: 1, higherIsBetter: false, aliases: ["oppRedZoneTdRate", "oppRedZoneTDRate", "defRedZoneTdRate", "redZoneTdRateAllowed", "defRedZonePct"], usedFor: ["eos_payout", "leaderboard"] }),
