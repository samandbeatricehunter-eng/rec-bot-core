...
export type CommissionerNotificationType =
  ...
  | "immortality_owner_tree_purchase"
  | "immortality_ability_change";
...
export type HubResponse = {
  ...
  myTeam: any;
  powerRankings: null | { completedWeekNumber: number | null; hasPreviousWeek: boolean; teams: Array<{ teamId: string; teamName: string; abbr: string | null; city: string | null; nick: string | null; conference: string | null; division: string | null; primaryColor: string | null; isHuman: boolean; ownerName: string | null; eaUsername: string | null; ownerLabel: string | null; rank: number; score: number; prevRank: number | null; change: number | null; wins: number; losses: number; ties: number; playoffMarker: "X" | "Y" | "Z" | null }> };
