...
/** Read + downscale an image file to a base64 data URL the API can re-host. Shared by every
 * headshot upload surface (League Mgmt roster photos, RTI Origins, RTI Overview tap-to-upload). */
