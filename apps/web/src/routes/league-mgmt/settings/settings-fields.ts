...
export const SETTINGS_CATEGORIES: SettingsCategory[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "devUpgradesSeasonCap", label: "Dev Upgrades Season Cap (total purchases per team)", type: "number", min: 0, max: 20, gameFilter: notCfb, dependsOn: (d) => Boolean(d.coinEconomyEnabled && d.devUpgradesEnabled), resetTo: 0 },
