...
export async function renderScheduleMenu(interaction: ButtonInteraction) {
  ...
  if (!interaction.guildId) {
    return interaction.editReply({
      embeds: [new EmbedBuilder().setTitle("Schedule").setDescription("Open this league on the REC site (rec-leagues.com) to view schedules.")],
...
export async function handleScheduleSos(interaction: ButtonInteraction) {
  ...
  if (!interaction.guildId) {
    return interaction.editReply({
      embeds: [new EmbedBuilder().setTitle("Strength of Schedule").setDescription("Open this league on the REC site (rec-leagues.com) to view SOS.")],
      components: buildScheduleRows(),
    });
  }
  try {
...
export async function handleSchedulePowerRankings(interaction: ButtonInteraction) {
  ...
  if (!interaction.guildId) {
    return interaction.editReply({
      embeds: [new EmbedBuilder().setTitle("Power Rankings").setDescription("Open this league on the REC site (rec-leagues.com) to view power rankings.")],
      components: buildScheduleRows(),
    });
  }
  try {
...
export async function startScheduleTeamSelect(interaction: ButtonInteraction) {
  await interaction.deferUpdate();
  if (!interaction.guildId) {
    return interaction.editReply({ embeds: [new EmbedBuilder().setTitle("View Other Teams").setDescription("Open this league on the REC site (rec-leagues.com).")], components: buildScheduleRows() });
  }
...
export async function handleScheduleStats(interaction: ButtonInteraction) {
  await interaction.deferUpdate();
  if (!interaction.guildId) return interaction.editReply({ embeds: [new EmbedBuilder().setTitle("Stats").setDescription("Open this league on the REC site (rec-leagues.com).")], components: buildScheduleRows() });
