...
const STAT_FIELDS: Record<string, Array<[string, string]>> = {
  ...
  receiving: [["receptions","Receptions"],["targets","Targets"],["yards","Receiving yards"],["touchdowns","Receiving touchdowns"],["drops","Drops"]],
  receiving_efficiency: [["yac","Yards after catch"],["longest","Longest reception"],["yards_per_reception","Yards per reception"],["yards_per_game","Receiving yards per game"]],
  ...
  punting: [["punts","Punts"],["yards","Punt yards"],["average","Punt average"],["net_average","Net punt average"],["longest","Longest punt"]],
  punting_detail: [["inside_20","Inside the 20"],["touchbacks","Touchbacks"],["punts_blocked","Punts blocked"],["fair_catches","Fair catches"],["return_yards_allowed","Return yards allowed"]],
};
