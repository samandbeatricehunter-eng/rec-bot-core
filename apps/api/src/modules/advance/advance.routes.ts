...
export async function advanceRoutes(app: FastifyInstance) {
  ...
  app.post("/v1/rosters/conferences", async (request) => getLeagueConferences((request.body as any).guildId));
  app.post("/v1/rosters/team", async (request) => getTeamRoster((request.body as any).guildId, (request.body as any).teamId));
}
