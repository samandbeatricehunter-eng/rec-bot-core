...
export async function advanceRoutes(app: FastifyInstance) {
  ...
  app.post("/v1/advance/dev-upgrade-prizes", async (request) => processDevUpgradePrizes((request.body as any).guildId));
}
