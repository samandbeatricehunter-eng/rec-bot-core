...
export async function writeAuditLog(input:{action:string;entityType:string;entityId?:string|null;previousValue?:Record<string,unknown>;newValue?:Record<string,unknown>;reason?:string|null;source?:"internal_import"|"madden_companion_export"|"manual_admin_entry"|"legacy_migration"|"admin_correction"|"automated_sweep";}) {
