...
import { approveAwardWinner, castAwardVote, closeAwardVoting, generateAwardNominees, getAwardStatus, getAwardVotingSummary, getPendingAwardApprovals, updateAwardVotingMessage } from "./rec-awards.service.js";
...
export async function recAwardsRoutes(app: FastifyInstance) {
  ...
  app.post("/v1/awards/voting-message", async (request) => updateAwardVotingMessage(request.body as any));
