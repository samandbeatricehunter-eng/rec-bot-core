...
export async function rebuildSeasonOfficialRecords(leagueId: string, seasonNumber: number) {
  ...
  // Season record wins/losses are regular-season-only (playoffs shown separately via their
  // own playoff_wins/playoff_losses columns, computed from the full result set).
