...
export const recServerRoutes = pgTable("rec_server_routes", {
  ...
  pendingPayoutsChannelId: text("pending_payouts_channel_id"),
  commissionerOfficeChannelId: text("commissioner_office_channel_id"),
  ...
  pendingPurchasesChannelId: text("pending_purchases_channel_id"),
