// Backfill game profiles + stories for every already-approved box score. Idempotent
// and re-import-safe — re-running recomputes from the stored rec_team_game_stats rows
// and only writes the two engine tables, so it never affects payouts, results, or stat
// rollups.
//
